...
export default function About({}: Props) {
  return (
    ...
    className='flex flex-col relative my-screen text-center md:text-left md:flex-row max-w-7xl sm:px-10 px-2 justify-evenly mx-auto items-center'>
       ...
       alt="profile picture"/>
        ...
        <div className='mt-6 md:mt-10 space-y-2 md:space-y-10 px-0 md:px-10'>
            <h4 className='text-base font-semibold sm:text-lg md:text-xl lg:text-2xl'>Here is a little background</h4>
            <p className='text-xs sm:text-base md:text-lg lg:text-xl w-full'>

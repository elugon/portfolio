                ...
                <div key={i} className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-10 md:p-44 h-screen'>
                    ...
                    <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                        ...
                        <p className='text-md md:text-lg text-center md:text-left'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis blanditiis atque ducimus, possimus quisquam laborum id adipisci explicabo fugiat alias nam ratione minus repudiandae sint nisi culpa assumenda veritatis temporibus.
                        </p>
                    </div>
                </div>
            ))}

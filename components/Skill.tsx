...
const javascript: any[] =[js,'https://developer.mozilla.org/en-US/docs/Web/JavaScript'];
...
const html5: any[] =[html,'https://developer.mozilla.org/en-US/docs/Glossary/HTML5']
...
const skillsLogos: any[] =[javascript,typescript,reactjs,css,tailwind,nextjs,html5,mongodb,nodejs,visualCode,git,gitHub]

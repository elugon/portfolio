    ...
    <div className="my-screen relative mx-auto flex max-w-7xl flex-col items-center justify-evenly px-10 text-center">
      ...
      <div className="flex flex-col space-y-10 pt-28">
        <h4 className="text-center text-xs font-semibold sm:text-lg md:text-xl">
          ...
          <span className="underline decoration-primary/50">{`Let's Talk`}</span>
        </h4>
      </div>

      <div className="mb-6 mt-4 h-10 space-y-2 md:mt-12">
        <div className="flex items-center space-x-5">
          <PhoneIcon className="h-5 w-5 animate-pulse text-primary sm:h-12 sm:w-12" />
          <p className="text-xs sm:text-lg">+34 634 91 86 59</p>
        </div>

        <div className="flex items-center space-x-5">
          <EnvelopeIcon className="h-5 w-5 animate-pulse text-primary sm:h-12 sm:w-12" />
          <p className="text-xs sm:text-lg">elugon10@gmail.com</p>
        </div>

        <div className="flex items-center space-x-5">
          <MapPinIcon className="h-5 w-5 animate-pulse text-primary sm:h-12 sm:w-12" />
      ...
      >
        ...
        <button
          type="submit"
          className="rounded-md bg-primary py-2 px-5 text-xs font-bold text-black md:text-lg"
        >
          Submit
        </button>
      </form>

...
export default function Experience({}: Props) {
  return (
    ...
    >
      ...
      <div className="flex h-max w-max snap-x snap-mandatory space-x-5 overflow-x-scroll scroll-smooth p-10 pt-6 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-primary sm:pt-16 md:pt-36 lg:pt-44 xl:justify-evenly">
